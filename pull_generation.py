...
class AbbAccess():
    ...
    def get_report(self,startdate,enddate):
        ...
        reporturl = "https://easyview.auroravision.net/easyview/services/gmi/summary/GenerationEnergy.json?type=GenerationEnergy&eids=4752320&tz=US%2FPacific&start={}&end={}&range=7D&hasUsage=false&label=7D&dataProperty=chartData&binSize=Hour&bins=true&plantPowerNow=false&v=2.1.51"
